...
void PrintHeader()
   ...
   MosPrintf(MIL_TEXT("[EXAMPLE NAME]\n")
             ...
             MIL_TEXT("Ranger C camera and scans an object to generate its depth map.\n\n")
...
#define DEPTH_MAP_SIZE_Y         220      /* in pixels            */
...
/*****************************************************************************
 Function that calibrates a 3d reconstruction setup with a SICK Ranger C camera
...
void RangerCExample(MIL_ID MilSystem, MIL_ID MilDisplay, MIL_INT ContextType)
   ...
   MosPrintf(MIL_TEXT("\n3D RECONSTRUCTION USING SICK RANGER C:\n"));
   MosPrintf(MIL_TEXT("------------------------------------\n\n"));
   MosPrintf(MIL_TEXT("This program calibrates a 3d reconstruction setup with a SICK\n"));
   MosPrintf(MIL_TEXT("Ranger C camera and scans an object to generate its depth map.\n\n"));
   ...
   /* Free result buffer used for laser line calibration. */
...
/*****************************************************************************
 ...
 switch SICK Ranger C camera to measurement mode.
...
/*****************************************************************************
 Reallocates digitizre with area-scan DCF and switch SICK Ranger C camera to
 measurement mode.
...
/*****************************************************************************
 Uses MimDraw() to show the image of the laser line the SICK Ranger C has extracted.
